...
const TYPES = ['report', 'guide', 'article', 'toolkit', 'video', 'podcast'] as const
...
export function KnowledgeFilters({ total, filtered }: Props) {
  ...
  const hasFilters = activeType || activeTheme
